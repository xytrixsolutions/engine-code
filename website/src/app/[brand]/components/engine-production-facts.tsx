      ...
      <div className="space-y-8">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automated storage and dispatch hub where finished engines
                    are stored before shipment to vehicle plants.
                  </p>
                </div>
                <div className="space-y-2">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Manufactures components for BMW i-series electric
                    drivetrains; hub for lightweight materials and e-mobility
                    innovation.
                  </p>
                </div>
                <div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Integrates AI-driven logistics (BEACON system) and
                    geothermal energy to power electric drivetrain production.
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Shift in production reflects EU emissions policy and consumer
              demand
            </CardDescription>
          </CardHeader>
          <CardContent>
